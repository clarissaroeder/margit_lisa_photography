        ...
        {collections.map((collection) => (
          <Link href={`/portfolio/collections/${collection.id}`} key={collection.id}>
            <div className="relative overflow-hidden group cursor-pointer h-80">
              ...
              />
              <div 
                className="absolute inset-0 flex items-center justify-center text-3xl text-white transition-opacity duration-300 opacity-0 group-hover:opacity-100 font-[family-name:var(--font-geist-sans)] uppercase"
